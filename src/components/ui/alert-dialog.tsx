...
export const AlertDialogHeader: React.FC<React.PropsWithChildren<{}>> = ({ children }) => (
  <>{children}</>
);
export const AlertDialogFooter: React.FC<React.PropsWithChildren<{}>> = ({ children }) => (
  <>{children}</>
);
export const AlertDialogTitle: React.FC<React.PropsWithChildren<{}>> = ({ children }) => (
  <>{children}</>
);
export const AlertDialogDescription: React.FC<React.PropsWithChildren<{}>> = ({ children }) => (
  <>{children}</>
);
