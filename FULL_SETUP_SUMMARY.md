...
Continue creating files phase by phase using Initial_Setup_Prompt.md as reference.
...
1. **Existing Code:** The project already has many files in place (actions, components, etc.)
